...
const char* ESP32HTTPUpdateServer::_serverIndex =
R"(<html><body><form method='POST' action='' enctype='multipart/form-data'>
                  <input type='file' name='update'>
                  <input type='submit' value='Update'>
               </form>
         </body></html>)";
const char* ESP32HTTPUpdateServer::_failedResponse = R"(Update Failed!)";
const char* ESP32HTTPUpdateServer::_successResponse = "<META http-equiv=\"refresh\" content=\"15;URL=\">Update Success! Rebooting...";
...
void ESP32HTTPUpdateServer::setup(N_ESP32WEBSERVER *server, const char * path, const char * username, const char * password)
{
    _server = server;
